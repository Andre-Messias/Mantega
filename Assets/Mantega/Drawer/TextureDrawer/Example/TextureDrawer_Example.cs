namespace Mantega.Drawer.Example
{
    ///
    ...
    public class TextureDrawer_Example : MonoBehaviour
    {
        [Header("Image")]
...
#if UNITY_EDITOR
    [CustomEditor(typeof(TextureDrawer_Example))]
    public class TextureDrawerExampleEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            TextureDrawer_Example script = (TextureDrawer_Example)target;
